...
import { placeholderClients, placeholderAppointments } from '@/lib/placeholder-data';
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">{t('dashboard.appointments_today')}</CardTitle>
